...
//The variable 'internal' is in nestedFunction()'s outer scope, making values there accessible by using a closure.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    const string = [];
    array.forEach(item => string.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`));
    return string;
  }
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce((count, item) => count + item.population, 0);
    return totalPop
  }
...
// console.log(`Cube volume:`, cube.volume()) // should be 27
// console.log(`Cube area:`, cube.surfaceArea()) // should be 54
